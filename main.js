...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dr, request.b6, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bw: fragment, bC: host, bR: path, bT: port_, bW: protocol, a: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cq: false, cz: r.cz, c1: r.c1, by: r.by, dr: r.dr, eo: r.eo, b4: r.b4, b6: r.b6}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cz: $elm$http$Http$emptyBody, c1: r.c1, by: _List_Nil, dr: 'GET', eo: $elm$core$Maybe$Nothing, b4: $elm$core$Maybe$Nothing, b6: r.b6});
};
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.bR),
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		var query = function () {
			var _v1 = A2($elm$url$Url$Parser$parse, $author$project$Main$queryParser, url);
			if (!_v1.$) {
				var q = _v1.a;
				return q;
			} else {
...
var $linuss$smooth_scroll$SmoothScroll$defaultConfig = {aW: $elm_community$easing_functions$Ease$outQuint, dv: 12, dZ: 200};
			...
			function (from, to) {
				return $elm$core$Task$sequence(
					A2(
						...
						A4($linuss$smooth_scroll$Internal$SmoothScroll$animationSteps, config.dZ, config.aW, from, to - config.dv)));
			});
		return A2(
			$elm$core$Task$andThen,
			function (_v0) {
				var viewport = _v0.a.b9;
...
var $mdgriffith$elm_ui$Internal$Style$classes = {cg: 'a', aR: 'atv', ci: 'ab', cj: 'cx', ck: 'cy', cl: 'acb', cm: 'accx', cn: 'accy', co: 'acr', bk: 'al', bl: 'ar', cp: 'at', aS: 'ah', aT: 'av', ct: 's', cx: 'bh', cy: 'b', cA: 'w7', cC: 'bd', cD: 'bdt', aB: 'bn', cE: 'bs', aC: 'cpe', cN: 'cp', cO: 'cpx', cP: 'cpy', O: 'c', aE: 'ctr', aF: 'cb', aG: 'ccx', P: 'ccy', au: 'cl', aH: 'cr', cS: 'ct', cU: 'cptr', cV: 'ctxt', c5: 'fcs', bv: 'focus-within', c6: 'fs', c7: 'g', aZ: 'hbh', a_: 'hc', bA: 'he', a$: 'hf', bB: 'hfp', c9: 'hv', dd: 'ic', df: 'fr', dh: 'iml', di: 'imlf', dj: 'imlp', dk: 'implw', dl: 'it', dn: 'i', bE: 'lnk', an: 'nb', bH: 'notxt', dx: 'ol', dz: 'or', aa: 'oq', dD: 'oh', bO: 'pg', bP: 'p', dF: 'ppe', dM: 'ui', E: 'r', dP: 'sb', dQ: 'sbx', dR: 'sby', dS: 'sbt', dV: 'e', dW: 'cap', dX: 'sev', d4: 'sk', t: 't', d8: 'tc', d9: 'w8', ea: 'w2', eb: 'w9', ec: 'tj', aQ: 'tja', ed: 'tl', ee: 'w3', ef: 'w5', eg: 'w4', eh: 'tr', ei: 'w6', ej: 'w1', ek: 'tun', b5: 'ts', af: 'clr', et: 'u', bg: 'wc', cb: 'we', bh: 'wf', cc: 'wfp', bi: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$getStyleName = function (style) {
	switch (style.$) {
		...
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.E) + ('-' + ($elm$core$String$fromInt(pos.cQ) + ('-' + ($elm$core$String$fromInt(pos.ca) + ('-' + $elm$core$String$fromInt(pos.bz)))))));
		case 11:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							...
							'grid-column: ' + ($elm$core$String$fromInt(position.cQ) + (' / ' + ($elm$core$String$fromInt(position.cQ + position.ca) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.E) + ('-' + ($elm$core$String$fromInt(position.cQ) + ('-' + ($elm$core$String$fromInt(position.ca) + ('-' + $elm$core$String$fromInt(position.bz)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bz: height / size, b1: size, b8: vertical};
	});
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ct, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.aE, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.co])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ct, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.aE, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.cm])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ct, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.aE, $mdgriffith$elm_ui$Internal$Style$classes.cn])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ct, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.aE, $mdgriffith$elm_ui$Internal$Style$classes.cl])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.ct + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.t + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a_)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.ct + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.t + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bh + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a$)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.cg]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.cy]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.dz]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.dx]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.dV, $mdgriffith$elm_ui$Internal$Style$classes.df]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.au)),
				A2(
					$elm$core$List$cons,
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dM, $mdgriffith$elm_ui$Internal$Style$classes.ct, $mdgriffith$elm_ui$Internal$Style$classes.dV]))),
...
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {ai: almostShade.ai, ak: almostShade.ak, bD: false, dv: almostShade.dv, b1: almostShade.b1};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var $mdgriffith$elm_ui$Element$Input$slider = F2(
	function (attributes, input) {
		...
		var factor = (input.ev - input.ds) / (input.dq - input.ds);
		var _v0 = input.el;
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{dg: $author$project$Main$init, dA: $author$project$Main$UrlChanged, dB: $author$project$Main$LinkClicked, d6: $author$project$Main$subscriptions, eu: $author$project$Main$update, ew: $author$project$Main$view});
