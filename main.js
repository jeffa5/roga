...
{
	if (region.bi.aw === region.by.aw)
	{
		return 'on line ' + region.bi.aw;
	}
	return 'on lines ' + region.bi.aw + ' through ' + region.by.aw;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { c9: 'hidden', cK: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { c9: 'mozHidden', cK: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { c9: 'msHidden', cK: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { c9: 'webkitHidden', cK: 'webkitvisibilitychange' }
		: { c9: 'hidden', cK: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		$elm$core$Maybe$isJust(request.b7) && _Http_track(router, xhr, request.b7.a);

		try {
			xhr.open(request.ds, request.aR, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bB: fragment, bG: host, dH: path, bW: port_, bZ: protocol, a: query};
	});
...
var $mdgriffith$elm_ui$Element$classifyDevice = function (window) {
	return {
		bv: function () {
			var shortSide = A2($elm$core$Basics$min, window.aS, window.a2);
			var longSide = A2($elm$core$Basics$max, window.aS, window.a2);
			return (shortSide < 600) ? 0 : ((longSide <= 1200) ? 1 : (((longSide > 1200) && (longSide <= 1920)) ? 2 : 3));
		}(),
		bR: (_Utils_cmp(window.aS, window.a2) < 0) ? 0 : 1
	};
};
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $author$project$Main$QueryParam = F4(
	function (name, _default, parser, builder) {
		return {bt: builder, A: _default, ba: name, bU: parser};
	});
...
var $author$project$Main$boolBuilder = F2(
	function (n, v) {
		return A2(
			$elm$url$Url$Builder$string,
			n,
			$author$project$Main$boolToString(v));
	});
...
var $author$project$Main$boolDict = $elm$core$Dict$fromList(
	_List_fromArray(
		[
...
var $author$project$Main$boolParser = F2(
	function (n, d) {
		return A2(
			$elm$url$Url$Parser$Query$map,
			$elm$core$Maybe$withDefault(d),
			A2($elm$url$Url$Parser$Query$enum, n, $author$project$Main$boolDict));
	});
...
var $author$project$Main$intBuilder = F2(
	function (n, v) {
		return A2($elm$url$Url$Builder$int, n, v);
	});
var $author$project$Main$intListToString = function (l) {
	return A2(
		$elm$core$String$join,
		',',
		A2($elm$core$List$map, $elm$core$String$fromInt, l));
};
var $author$project$Main$intListBuilder = F2(
	function (n, v) {
		return A2(
			$elm$url$Url$Builder$string,
			n,
			$author$project$Main$intListToString(v));
	});
...
var $author$project$Main$intListParser = F2(
	function (n, _v0) {
		return A2(
			$elm$url$Url$Parser$Query$map,
			function (s) {
			...
			$elm$url$Url$Parser$Query$string(n));
	});
...
var $author$project$Main$intParser = F2(
	function (n, d) {
		return A2(
			$elm$url$Url$Parser$Query$map,
			$elm$core$Maybe$withDefault(d),
			$elm$url$Url$Parser$Query$int(n));
	});
var $elm$time$Time$Posix = $elm$core$Basics$identity;
var $elm$time$Time$millisToPosix = $elm$core$Basics$identity;
var $author$project$Main$seconds = function (s) {
...
var $author$project$Main$toSeconds = function (t) {
	return ($elm$time$Time$posixToMillis(t) / 1000) | 0;
};
var $author$project$Main$timeBuilder = F2(
	function (n, v) {
		return A2(
			$author$project$Main$intBuilder,
			n,
			$author$project$Main$toSeconds(v));
	});
var $author$project$Main$timeParser = F2(
	function (n, d) {
		return A2(
			$elm$url$Url$Parser$Query$map,
			$author$project$Main$seconds,
			A2(
				$author$project$Main$intParser,
				n,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cr: false, cA: r.cA, c2: r.c2, bD: r.bD, ds: r.ds, eq: r.eq, b7: r.b7, aR: r.aR}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cA: $elm$http$Http$emptyBody, c2: r.c2, bD: _List_Nil, ds: 'GET', eq: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing, aR: r.aR});
};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$Pose = F6(
	function (benefits, pose, asana, level, image, id) {
		return {br: asana, bs: benefits, a5: id, a6: image, a8: level, bc: pose};
	});
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$asanaDecoder = A2($elm$json$Json$Decode$field, 'asana', $elm$json$Json$Decode$string);
var $author$project$Main$benefitsDecoder = A2(
	$elm$json$Json$Decode$field,
	'benefits',
	$elm$json$Json$Decode$list($elm$json$Json$Decode$string));
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Main$idDecoder = A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int);
var $author$project$Main$imageDecoder = A2($elm$json$Json$Decode$field, 'image', $elm$json$Json$Decode$string);
var $author$project$Main$levelDecoder = A2($elm$json$Json$Decode$field, 'level', $elm$json$Json$Decode$string);
var $elm$json$Json$Decode$map6 = _Json_map6;
var $author$project$Main$posenameDecoder = A2($elm$json$Json$Decode$field, 'pose', $elm$json$Json$Decode$string);
var $author$project$Main$poseDecoder = A7($elm$json$Json$Decode$map6, $author$project$Main$Pose, $author$project$Main$benefitsDecoder, $author$project$Main$posenameDecoder, $author$project$Main$asanaDecoder, $author$project$Main$levelDecoder, $author$project$Main$imageDecoder, $author$project$Main$idDecoder);
var $author$project$Main$posesDecoder = A2(
	$elm$json$Json$Decode$field,
	'poses',
	$elm$json$Json$Decode$list($author$project$Main$poseDecoder));
var $author$project$Main$getPoses = $elm$http$Http$get(
	{
		c2: A2($elm$http$Http$expectJson, $author$project$Main$GotPoses, $author$project$Main$posesDecoder),
		aR: 'poses.json'
	});
var $author$project$Main$normalizedUrl = function (url) {
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {Y: frag, ab: params, T: unvisited, ex: value, ag: visited};
	});
...
var $author$project$Main$queryParser = $elm$url$Url$Parser$query(
	A8(
...
var $author$project$Main$init = F3(
	function (windowJson, url, key) {
		var window = function () {
			var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$windowDecoder, windowJson);
			if (!_v1.$) {
				var w = _v1.a;
				return w;
			} else {
		...
		var query = function () {
			var _v0 = A2(
				...
				$author$project$Main$queryParser,
				$author$project$Main$normalizedUrl(url));
			if (!_v0.$) {
				var q = _v0.a;
				return q;
			} else {
				return $author$project$Main$defaultQuery;
			}
		}();
		return _Utils_Tuple2(
			{
				aZ: $mdgriffith$elm_ui$Element$classifyDevice(window),
				X: false,
				I: false,
				w: key,
				ac: $author$project$Main$Loading,
				a: query,
				aT: window,
				ah: false,
				u: 0,
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {bY: processes, b6: taggers};
	});
...
var $elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _v0 = A2($elm$core$Dict$get, interval, state.b6);
		if (_v0.$ === 1) {
			return $elm$core$Task$succeed(state);
		} else {
			var taggers = _v0.a;
...
var $author$project$Main$Advanced = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$Beginner = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$Break = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$BreakDuration = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$ExerciseDuration = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$Failure = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$Intermediate = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$NumPoses = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$preFilter = F4(
	function (b, i, a, poses) {
		return A2(
			$elm$core$List$map,
			function (p) {
				return p.a5;
...
var $author$project$Main$randomPoses = F2(
	function (poseIDs, n) {
		return A2(
			$elm$random$Random$map,
			$elm$core$List$take(n),
			$elm_community$random_extra$Random$List$shuffle(poseIDs));
	});
var $author$project$Main$filterPoses = F2(
	function (model, poses) {
		return A2(
...
var $author$project$Main$getSelectedPoses = F2(
	function (poses, ids) {
...
var $linuss$smooth_scroll$SmoothScroll$defaultConfig = {a_: $elm_community$easing_functions$Ease$outQuint, dw: 12, d$: 200};
var $author$project$Main$scrollConfig = _Utils_update(
	$linuss$smooth_scroll$SmoothScroll$defaultConfig,
	{dw: 150, d$: 100});
			...
			function (from, to) {
				return $elm$core$Task$sequence(
					A2(
						...
						A4($linuss$smooth_scroll$Internal$SmoothScroll$animationSteps, config.d$, config.a_, from, to - config.dw)));
			});
		return A2(
			$elm$core$Task$andThen,
			function (_v0) {
				var viewport = _v0.a.cb;
				var element = _v0.b.c1;
				return A2(tasks, viewport.cf, element.cf);
			},
			A3(
				$elm$core$Task$map2,
				$elm$core$Tuple$pair,
...
var $author$project$Main$scrollToExercise = function (i) {
	return A2(
		$elm$core$Task$attempt,
		$elm$core$Basics$always($author$project$Main$NoOp),
		A2(
			$linuss$smooth_scroll$SmoothScroll$scrollToWithOptions,
			$author$project$Main$scrollConfig,
			'exercise' + $elm$core$String$fromInt(i)));
};
var $author$project$Main$scrollToTitle = A2(
	$elm$core$Task$attempt,
	$elm$core$Basics$always($author$project$Main$NoOp),
	A2($linuss$smooth_scroll$SmoothScroll$scrollToWithOptions, $author$project$Main$scrollConfig, 'title'));
...
var $author$project$Main$paramBuilder = F2(
	function (qp, v) {
		return (!_Utils_eq(qp.A, v)) ? $elm$core$Maybe$Just(
			A2(qp.bt, qp.ba, v)) : $elm$core$Maybe$Nothing;
	});
...
var $author$project$Main$queryBuilder = function (q) {
	return A2(
	...
	function (msg, key, query) {
		...
		return _Utils_Tuple2(
			...
			A2(
				...
				key,
				$author$project$Main$queryBuilder(newQuery)));
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				...
				if (!result.$) {
					var poses = result.a;
					var posesDict = $elm$core$Dict$fromList(
						A2(
							$elm$core$List$map,
							function (p) {
								return _Utils_Tuple2(p.a5, p);
							},
							poses));
					...
					return (!$elm$core$List$length(model.a.k)) ? _Utils_Tuple2(
						_Utils_update(
							newModel,
							{X: true}),
						A2($author$project$Main$filterPoses, model, poses)) : _Utils_Tuple2(newModel, $elm$core$Platform$Cmd$none);
				} else {
					var err = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								ac: $author$project$Main$Failure(err)
							}),
				...
				if (_v6.$ === 2) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{X: true}),
						A2(
							$author$project$Main$filterPoses,
							model,
							$elm$core$Dict$values(p)));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 7:
				...
				if (_v11.$ === 2) {
					...
					if ((!model.X) && (!(!$elm$core$List$length(model.a.k)))) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{I: true, ah: false, u: 0, M: workout}),
							$author$project$Main$scrollToExercise(0));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				} else {
				...
				if (!model.I) {
					...
					if (model.ah) {
						...
						var newModel = _Utils_eq(
							...
							model,
							{I: true, ah: true, u: j}) : _Utils_update(
							model,
							{u: j});
						var cmd = (model.I && (!_Utils_eq(model.u, j))) ? $elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
...
var $author$project$Main$blue = A3($mdgriffith$elm_ui$Element$rgb255, 50, 50, 200);
var $mdgriffith$elm_ui$Internal$Model$Class = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $mdgriffith$elm_ui$Internal$Style$classes = {ch: 'a', aU: 'atv', cj: 'ab', ck: 'cx', cl: 'cy', cm: 'acb', cn: 'accx', co: 'accy', cp: 'acr', bp: 'al', bq: 'ar', cq: 'at', aV: 'ah', aW: 'av', cu: 's', cy: 'bh', cz: 'b', cB: 'w7', cD: 'bd', cE: 'bdt', aC: 'bn', cF: 'bs', aD: 'cpe', cO: 'cp', cP: 'cpx', cQ: 'cpy', O: 'c', aF: 'ctr', aG: 'cb', aH: 'ccx', P: 'ccy', av: 'cl', aI: 'cr', cT: 'ct', cV: 'cptr', cW: 'ctxt', c6: 'fcs', bA: 'focus-within', c7: 'fs', c8: 'g', a1: 'hbh', a3: 'hc', bE: 'he', a4: 'hf', bF: 'hfp', da: 'hv', de: 'ic', dg: 'fr', di: 'iml', dj: 'imlf', dk: 'imlp', dl: 'implw', dm: 'it', $7: 'i', bI: 'lnk', ao: 'nb', bL: 'notxt', dy: 'ol', dA: 'or', aa: 'oq', dE: 'oh', bS: 'pg', bT: 'p', dG: 'ppe', dO: 'ui', E: 'r', dR: 'sb', dS: 'sbx', dT: 'sby', dU: 'sbt', dX: 'e', dY: 'cap', dZ: 'sev', d6: 'sk', t: 't', ea: 'tc', eb: 'w8', ec: 'w2', ed: 'w9', ee: 'tj', aQ: 'tja', ef: 'tl', eg: 'w3', eh: 'w5', ei: 'w4', ej: 'tr', ek: 'w6', el: 'w1', em: 'tun', b8: 'ts', af: 'clr', ev: 'u', bl: 'wc', cc: 'we', bm: 'wf', cd: 'wfp', bn: 'wrp'};
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.cB);
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.O);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c8);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bS);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bT);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.E);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dX);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.G)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.d_.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.d_.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.E) + ('-' + ($elm$core$String$fromInt(pos.cR) + ('-' + ($elm$core$String$fromInt(pos.aS) + ('-' + $elm$core$String$fromInt(pos.a2)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.da, $mdgriffith$elm_ui$Internal$Style$classes.af)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.c6, $mdgriffith$elm_ui$Internal$Style$classes.af)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aU, $mdgriffith$elm_ui$Internal$Style$classes.af)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cu) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.E) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cu) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cu) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.E) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cu) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aF) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aE: closing, l: _List_Nil, S: _List_Nil, L: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.L + ('{' + (renderValues(rule.S) + (rule.aE + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.E) + (' / ' + ($elm$core$String$fromInt(position.E + position.a2) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cR) + (' / ' + ($elm$core$String$fromInt(position.cR + position.aS) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.E) + ('-' + ($elm$core$String$fromInt(position.cR) + ('-' + ($elm$core$String$fromInt(position.aS) + ('-' + $elm$core$String$fromInt(position.a2)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dY + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.t + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dY + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.t)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {a2: height / size, b4: size, ca: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cJ, adjustment.cx, adjustment.c_, adjustment.dq]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dX))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cu, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.aF, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.cp])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cu, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.aF, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.cn])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cu, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.aF, $mdgriffith$elm_ui$Internal$Style$classes.co])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cu, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.aF, $mdgriffith$elm_ui$Internal$Style$classes.cm])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.t + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bl + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a3)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cu + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.t + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bm + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a4)))));
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.V)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.V)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.ch]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.cz]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.dA]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.dy]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.dg]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.cy]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bp);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bq);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aV + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ck);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aW + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cq);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aW + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cj);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aW + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cl);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.cu + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.O + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.cu + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.E + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.cc + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.cd + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cT + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.av)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{c6: $elm$core$Maybe$Nothing, da: $elm$core$Maybe$Nothing, du: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dO, $mdgriffith$elm_ui$Internal$Style$classes.cu, $mdgriffith$elm_ui$Internal$Style$classes.dX]))),
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aH + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.P + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bI)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.av + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.P)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Main$Filter = {$: 6};
var $author$project$Main$FilterAdvanced = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$FilterBeginner = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$FilterIntermediate = function (a) {
	return {$: 4, a: a};
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aH + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.P + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bL)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$Main$grey = A3($mdgriffith$elm_ui$Element$rgb255, 221, 221, 221);
...
var $author$project$Main$viewButton = F2(
	function (op, l) {
		return A2(
			...
			{
				an: $mdgriffith$elm_ui$Element$text(l),
				dz: $elm$core$Maybe$Just(op)
			});
	});
	...
	return $elm$core$String$concat(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.dw.a) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.dw.b) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.ai) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.b4) + 'px',
				$mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.ak)
			]));
};
var $mdgriffith$elm_ui$Internal$Flag$shadows = $mdgriffith$elm_ui$Internal$Flag$flag(19);
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {ai: almostShade.ai, ak: almostShade.ak, bH: false, dw: almostShade.dw, b4: almostShade.b4};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var $author$project$Main$viewCheckbox = F3(
	function (l, c, oc) {
		return A2(
			...
			{
				cM: c,
				dc: $mdgriffith$elm_ui$Element$Input$defaultCheckbox,
				an: A2(
...
var $mdgriffith$elm_ui$Element$Input$slider = F2(
	function (attributes, input) {
		...
		var factor = (input.ex - input.dt) / (input.dr - input.dt);
		var _v0 = input.en;
		...
		return A3(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(input.an) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : A2($mdgriffith$elm_ui$Element$spacingXY, spacingX, spacingY),
					$mdgriffith$elm_ui$Element$Region$announce,
					$mdgriffith$elm_ui$Element$width(
					function () {
						if (trackWidth.$ === 1) {
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(input.an),
								A2(
								$mdgriffith$elm_ui$Internal$Model$StyleClass,
								...
								$elm$html$Html$Attributes$value(
									$elm$core$String$fromFloat(input.ex))),
...
var $author$project$Main$viewNumberInput = F5(
	function (name, min, max, val, oi) {
		return A2(
				...
				]),
			{
				...
				dr: max,
				dt: min,
				bM: A2($elm$core$Basics$composeR, $elm$core$Basics$round, oi),
				d4: $elm$core$Maybe$Just(1),
...
var $author$project$Main$viewTime = function (t) {
	var sec = A2($elm$time$Time$toSecond, $elm$time$Time$utc, t);
	var min = A2($elm$time$Time$toMinute, $elm$time$Time$utc, t);
	var hour = A2($elm$time$Time$toHour, $elm$time$Time$utc, t);
	return A2(
		$elm$core$String$join,
		' ',
		_Utils_ap(
			(!(!hour)) ? _List_fromArray(
				[
					$elm$core$String$fromInt(hour) + 'h'
				]) : _List_Nil,
			_Utils_ap(
				(!(!min)) ? _List_fromArray(
					[
						$elm$core$String$fromInt(min) + 'm'
					]) : _List_Nil,
				(!(!sec)) ? _List_fromArray(
					[
						$elm$core$String$fromInt(sec) + 's'
					]) : (((!hour) && (!min)) ? _List_fromArray(
					[
						$elm$core$String$fromInt(sec) + 's'
					]) : _List_Nil))));
};
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.av + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.P + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bn)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
				...
				if (!padded.$) {
					...
					return ((_Utils_cmp(r, (x / 2) | 0) > -1) && (_Utils_cmp(b, (y / 2) | 0) > -1)) ? $elm$core$Maybe$Just(
						$mdgriffith$elm_ui$Element$paddingEach(
							{au: b - ((y / 2) | 0), a7: l - ((x / 2) | 0), bf: r - ((x / 2) | 0), bk: t - ((y / 2) | 0)})) : $elm$core$Maybe$Nothing;
				} else {
					return $elm$core$Maybe$Nothing;
				}
			}();
						...
						A2(
							...
							_List_fromArray(
								[
									...
									'Number of Poses: ' + $elm$core$String$fromInt(model.a.s),
									1,
									50,
									model.a.s,
					...
					[
						...
						A2(
							...
							$mdgriffith$elm_ui$Element$text(
								$author$project$Main$viewTime(workoutDuration)))),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						A2(
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX]),
							A2($author$project$Main$viewButton, $author$project$Main$StartWorkout, 'Start')))
					]))
			]));
};
var $author$project$Main$sides = {au: 0, a7: 0, bf: 0, bk: 0};
...
var $author$project$Main$viewPoseImage = function (p) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.$7);
...
var $author$project$Main$viewPoseText = function (p) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(p.bc),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$italic]),
							$mdgriffith$elm_ui$Element$text(' (' + (p.br + ')')))
						]))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
				...
				$mdgriffith$elm_ui$Element$text(p.a8)),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_Nil,
				A2(
...
var $author$project$Main$viewPose = F2(
	function (id, pose) {
		return A2(
			$mdgriffith$elm_ui$Element$wrappedRow,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$author$project$Main$viewPoseImage(pose),
					$author$project$Main$viewPoseText(pose)
				]));
	});
var $author$project$Main$viewPoses = function (model) {
	var _v0 = model.ac;
	switch (_v0.$) {
		case 2:
			var poses = _v0.a;
			if (!model.X) {
				...
				if (!_v1.b) {
					return A2(
						...
						A2(
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX]),
							$mdgriffith$elm_ui$Element$text('No poses to show')));
				} else {
					return A2(
						$mdgriffith$elm_ui$Element$column,
						_List_fromArray(
							...
							F2(
								function (i, pose) {
									return A2(
										...
										_List_fromArray(
											[
												(!i) ? $mdgriffith$elm_ui$Element$Border$widthEach(
												_Utils_update(
													$author$project$Main$sides,
													{au: 1, bk: 1})) : $mdgriffith$elm_ui$Element$Border$widthEach(
												_Utils_update(
													$author$project$Main$sides,
													{au: 1})),
				...
				return A2(
					...
					A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$mdgriffith$elm_ui$Element$text('Filtering...')));
			}
		case 1:
			return A2(
				$mdgriffith$elm_ui$Element$el,
...
var $author$project$Main$viewBreak = function (id) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text('Break'));
};
		...
		var time = function (t) {
			return $mdgriffith$elm_ui$Element$inFront(
				A2(
					...
					$mdgriffith$elm_ui$Element$text(
						(!$elm$time$Time$posixToMillis(t)) ? '' : $author$project$Main$viewTime(t))));
		};
		var isHighlighted = _Utils_eq(i, model.u);
		var cancelButton = $mdgriffith$elm_ui$Element$inFront(
			A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2($author$project$Main$viewButton, $author$project$Main$CancelWorkout, 'Cancel')));
		if (!exercise.$) {
			var _v2 = exercise.a;
			var pose = _v2.a;
			var t = _v2.b;
			return A2(
				...
				_Utils_ap(
					...
					isHighlighted ? _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color($author$project$Main$highlight)
						]) : _List_Nil),
				_List_fromArray(
					[
						A2(
						...
						$mdgriffith$elm_ui$Element$text('Exercise')),
						A2(
						$author$project$Main$viewPose,
						'exercise' + $elm$core$String$fromInt(i),
						pose)
					]));
		} else {
			...
			return A2(
				...
				$author$project$Main$viewBreak(
					'exercise' + $elm$core$String$fromInt(i)));
		}
	});
var $author$project$Main$viewWorkout = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_Utils_ap(
			A2(
				$elm$core$List$map,
				$author$project$Main$viewExercise(model),
				A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, model.M)),
			_Utils_eq(
				model.u,
				$elm$core$List$length(model.M)) ? _List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$id(
									'exercise' + $elm$core$String$fromInt(model.u)))
							]),
						A2($author$project$Main$viewButton, $author$project$Main$CompleteWorkout, 'Complete Workout')))
				]) : _List_Nil));
};
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('Roga')),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$width(
									A2($mdgriffith$elm_ui$Element$maximum, model.aT.aS, $mdgriffith$elm_ui$Element$shrink)),
									$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
									$mdgriffith$elm_ui$Element$centerX
								]),
							model.I ? _List_fromArray(
								[
									...
									A2(
										...
										_List_Nil)),
									$author$project$Main$viewWorkout(model)
								]) : _List_fromArray(
								[
									$author$project$Main$viewFilters(model),
									$author$project$Main$viewPoses(model)
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
									...
									A2(
										...
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$el,
												_List_Nil,
												$mdgriffith$elm_ui$Element$text('Roga by ')),
												A2(
												$mdgriffith$elm_ui$Element$link,
												_List_fromArray(
													[
													...
													]),
												{
													an: A2(
														$mdgriffith$elm_ui$Element$el,
														_List_Nil,
														$mdgriffith$elm_ui$Element$text('Jeffas')),
													aR: 'https://jeffas.io'
												})
											]))),
									A2(
									...
									A2(
										...
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$el,
												_List_Nil,
												$mdgriffith$elm_ui$Element$text('Source available on ')),
												A2(
												$mdgriffith$elm_ui$Element$link,
												_List_fromArray(
													[
													...
													]),
												{
													...
													aR: 'https://github.com/jeffa5/roga'
												})
											])))
								]))
						])))
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{dh: $author$project$Main$init, dB: $author$project$Main$UrlChanged, dC: $author$project$Main$LinkClicked, d8: $author$project$Main$subscriptions, ew: $author$project$Main$update, ey: $author$project$Main$view});
